...
- [x] What steps can you take in your web apps to keep your data secure?
        ...
        Keep sotware up to date
        Use private route
        Enforce strong password policy

- [x] Describe how web servers work.

        A web server processes incoming network requests over HTTP and several other related protocols. The primary function of a web server is to store, process and deliver files and web pages to clients
